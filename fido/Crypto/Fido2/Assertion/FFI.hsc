...
module Crypto.Fido2.Assertion.FFI
  ( c_fido_assert_new,
    c_fido_assert_free,
    c_fido_assert_count,
    c_fido_assert_rp_id,
    c_fido_assert_user_display_name,
    c_fido_assert_user_icon,
    c_fido_assert_user_name,
    c_fido_assert_authdata_ptr,
    c_fido_assert_client_data_hash_ptr,
    c_fido_assert_blob_ptr,
    c_fido_assert_hmac_secret_ptr,
    c_fido_assert_largeblob_key_ptr,
    c_fido_assert_user_sig_ptr,
    c_fido_assert_user_id_ptr,
    c_fido_assert_authdata_len,
    c_fido_assert_clientdata_hash_len,
    c_fido_assert_blob_len,
    c_fido_assert_hmac_secret_len,
    c_fido_assert_largeblob_key_len,
    c_fido_assert_user_id_len,
    c_fido_assert_sig_len,
    c_fido_assert_id_len,
    c_fido_assert_sigcount,
    c_fido_assert_flags,
    c_fido_assert_set_authdata,
    c_fido_assert_set_authdata_raw,
    c_fido_assert_set_clientdata,
    c_fido_assert_set_clientdata_hash,
    c_fido_assert_set_count,
    c_fido_assert_set_extensions,
    c_fido_assert_set_hmac_salt,
    c_fido_assert_set_hmac_secret,
    c_fido_assert_set_up,
    c_fido_assert_set_uv,
    c_fido_assert_set_rp,
    c_fido_assert_set_sig,
    c_fido_assert_verify,
  )
where
